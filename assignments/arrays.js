...
let lastCar = 49;
console.log(`Car ${lastCar} is a ${inventory[lastCar].car_make} ${inventory[lastCar].car_model}`);
...
/*
yearCount = {1999: 5, 2000: 3};

for (let i = 0; i < carYears.length;i++){
  if (carYears[i] in inventory) {
    yearCount[carYears[i]];
  }
}
*/
